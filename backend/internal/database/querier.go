...
type Querier interface {
	...
	UpdateAssessmentDecisionRecord(ctx context.Context, arg UpdateAssessmentDecisionRecordParams) (FeasibilityAssessment, error)
	UpdateAssessmentFullResults(ctx context.Context, arg UpdateAssessmentFullResultsParams) (FeasibilityAssessment, error)

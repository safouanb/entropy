...
export async function GET() {
    try {
        ...
        await predictionService.createDataCenter(dc1).catch(e => console.log("DC1 likely exists", e));
        await predictionService.createDataCenter(dc2).catch(e => console.log("DC2 likely exists", e));
        await predictionService.createDataCenter(dc3).catch(e => console.log("DC3 likely exists", e));
        ...
        await predictionService.createHeatSink(hs1).catch(e => console.log("HS1 likely exists", e));
        await predictionService.createHeatSink(hs2).catch(e => console.log("HS2 likely exists", e));

...
const DEFAULT_GLOW_COLOR = '16, 185, 129'; // Emerald to match your theme
...
const defaultCards: MagicBentoCard[] = [
  {
    color: '#0a0a0a',
    title: 'Analytics',
  ...
  },
  {
    color: '#0a0a0a',
    title: 'Dashboard',
    description: 'Centralized data view and control center',
    label: 'Overview'
  },
  {
    color: '#0a0a0a',
    title: 'Compliance',
    description: 'Regulatory adherence monitoring',
    label: 'Safety'
  },
  {
    color: '#0a0a0a',
    title: 'Heat Mapping',
    description: 'Visualize thermal distribution patterns',
    label: 'Mapping'
  },
  {
    color: '#0a0a0a',
    title: 'Predictions',
    description: 'AI-powered forecasting and analysis',
    label: 'Intelligence'
  },
  {
    color: '#0a0a0a',
            ...
            return (
              ...
              >
                <div className="magic-bento-card__header">
                  ...
                  {card.icon && <card.icon className="w-5 h-5 text-emerald-400/70" />}
                </div>
